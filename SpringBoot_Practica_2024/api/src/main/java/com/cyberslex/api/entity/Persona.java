...
//	private Long id;
	...
	// La diferencia con @ManyToOne, se encuentra en cuàl es la entidad hija (débil) y cuál la fuerte. En este caso, la entidad Libro es la fuerte (padre) es la que es "muchos" (1 perona puede tener muchos libros). Si la entidad fuerte es muchos, luego entonces se usa la anotación @OneToMany.
