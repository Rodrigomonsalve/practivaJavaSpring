...
// EN JAVA TODA LA LÓGICA DE PROGRAMACIÓN ESTA AGRUPADA EN MÓDULOS(MÉTODOS) ---> ESTO ES LA "MODULARIDAD" DE JAVA.
// AYUDAD A REUTILIZAR ESE CÓDIGO, DA ORDEN Y AYUDA  A SEPARAR TAREAS DEL EQUIPO.
//TIPO DE DATO ABSTRACTO(TDA): TIPO DE DATO DEFINIDO POR EL PROGRAMADOR (OBJETOS).
