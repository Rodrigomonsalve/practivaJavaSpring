...
public class ConsumerExamples {
	...
	public static void main(String[] args) {
		...
		usingBiConsumer(4,1000, (e,v)->printBefore(e, v));
	...
	private static void printBefore(Integer e, Integer v) {
		System.out.println("En el index: "+e+" "
				+ "se intenta añadir el elemento " +v);
	}
	
	private static<T,U> void usingBiConsumer(T value, U otherValue, BiConsumer<T,U>  biconsume) {
		
		biconsume.accept(value, otherValue);
