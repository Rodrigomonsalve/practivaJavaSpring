...
public class ClasesYmetodos extends Empleados {
	
	static {
		System.out.println("Ejecutando bloque estático");  // LOS BLOQUES ESTÁTICOS SIRVEN PARA QUE ESTA PARTE SE EJECUTE SIEMPRE Y EN TODOO MOMENTO AL EJECUTARSE ALGO DE ESTA CLASE. Parecido a las funciones autoejecutables de Javascript.
	}
	
	
	{
		
		System.out.println("Ejecutando bloque de inicialización de instancia"); //LOS BLOQUES DE INICIALIZCIÓN DE INSTANCIA, SIRVEN PARA QUE SIEMPRE SE EJECUTE CUANNDO SE CREE UNA INSTANCIA DE ESTA CLASE. Parecido a las funciones autoejecutables de Javascript.
	}
	...
	public ClasesYmetodos(int variable6) {
		super();
	...
	public void vargArgs(int... numero) {//Este es el operador varargs y sirve para poder ingresar el número de parámetros que deseemos.  EN JAVASCRIPT SE LLAMA OPERADOR REST.
