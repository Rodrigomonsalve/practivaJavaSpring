--QUERIES USADOS POR EL AMBIENTE "dev".
--PODEMOS USAR ESTE ARCHIVO, AUN Y CUANDO SEA UNA BD MYSQL, PORQUE ESTAMOS USANDO spring.jpa.hibernate.ddl-auto=create-drop EN EL application.properties.
