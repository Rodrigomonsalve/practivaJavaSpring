package com.cyberslex.API_REST_COMPLETO.config;
...
@EnableWebMvc 
@ComponentScan(basePackages="com.cyberslex.API_REST_COMPLETO") //Hay que recordar que, derivado de que se usa la anotación @Configuration, este archivo es un contenedor de beans, por lo que necesitamos decirle en qué paquete los debe buscar.
public class App {
