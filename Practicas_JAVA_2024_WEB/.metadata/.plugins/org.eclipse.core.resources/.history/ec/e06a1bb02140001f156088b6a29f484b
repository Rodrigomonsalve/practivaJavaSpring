...
public int Cadena(int numero1, int numero2){
 ...
 El resultado de la suma es <%=Cadena(10, 8)  // Esto es una Expresión y NO debe cumplir con sitaxis Java. Es arbitrario. Si quieres imprimir un resulltado en pantalla, basta con invocar un método, lo que no sucede en sitaxis Java (no utilizamos un system.out ni lo invocamos dentro de un método main)
